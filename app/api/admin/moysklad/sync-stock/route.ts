...
import { syncAllStock } from "@/lib/moysklad";
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error("MoySklad stock sync error:", error);
    return apiError(
      error instanceof Error ? error.message : "Ошибка синхронизации остатков",
      500,
      "SYNC_ERROR",
    );
  }
