              ...
              <SheetContent side="left" className="w-[320px] bg-white border-r border-neutral-200 p-0 overflow-y-auto">
                ...
                <div className="px-5 mb-4">
                  <Link
                    ...
                    className="flex items-center justify-between rounded-xl bg-primary px-4 py-2.5 text-white"
                  >
        ...
        <Container>
          <div className="flex items-center">
            ...
            <div className="ml-auto flex items-center gap-3">
              ...
              <button
                onClick={() => window.dispatchEvent(new Event("open-ai-chat"))}
                className="flex items-center gap-2 rounded-xl bg-primary px-3 py-1.5 text-xs font-bold text-white hover:bg-primary/80 transition-all cursor-pointer group"
              >
